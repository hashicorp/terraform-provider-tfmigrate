...
import (
	...
	utilgit "terraform-provider-tfmigrate/internal/util/git"
)
...
// MockGitUtil_CreateGitlabMergeRequest_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CreateGitlabMergeRequest'
type MockGitUtil_CreateGitlabMergeRequest_Call struct {
	*mock.Call
}
...
func (_c *MockGitUtil_CreateGitlabMergeRequest_Call) Return(_a0 *gitlab.MergeRequest, _a1 error) *MockGitUtil_CreateGitlabMergeRequest_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
...
// GlobalGitConfig provides a mock function with given fields:
func (_m *MockGitUtil) GlobalGitConfig() (utilgit.GitUserConfig, error) {
	ret := _m.Called()
	...
	var r0 utilgit.GitUserConfig
	var r1 error
	if rf, ok := ret.Get(0).(func() (utilgit.GitUserConfig, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() utilgit.GitUserConfig); ok {
		r0 = rf()
	} else {
		r0 = ret.Get(0).(utilgit.GitUserConfig)
	}
...
func (_c *MockGitUtil_GlobalGitConfig_Call) Return(_a0 utilgit.GitUserConfig, _a1 error) *MockGitUtil_GlobalGitConfig_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockGitUtil_GlobalGitConfig_Call) RunAndReturn(run func() (utilgit.GitUserConfig, error)) *MockGitUtil_GlobalGitConfig_Call {
	_c.Call.Return(run)
	return _c
}
