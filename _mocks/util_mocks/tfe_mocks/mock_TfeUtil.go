...
func (_c *MockTfeUtil_ReadLatestDeploymentRun_Call) Return(_a0 *go_tfe.StackDeploymentRun, _a1 error) *MockTfeUtil_ReadLatestDeploymentRun_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
...
func (_m *MockTfeUtil) ReadWorkspaceByName(organizationName string, workspaceName string, client *go_tfe.Client) (*go_tfe.Workspace, error) {
	...
	var r0 *go_tfe.Workspace
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string, *go_tfe.Client) (*go_tfe.Workspace, error)); ok {
		return rf(organizationName, workspaceName, client)
	}
	if rf, ok := ret.Get(0).(func(string, string, *go_tfe.Client) *go_tfe.Workspace); ok {
		r0 = rf(organizationName, workspaceName, client)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*go_tfe.Workspace)
		}
	}
...
func (_c *MockTfeUtil_ReadWorkspaceByName_Call) Run(run func(organizationName string, workspaceName string, client *go_tfe.Client)) *MockTfeUtil_ReadWorkspaceByName_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(string), args[2].(*go_tfe.Client))
	})
	return _c
...
func (_c *MockTfeUtil_ReadWorkspaceByName_Call) Return(_a0 *go_tfe.Workspace, _a1 error) *MockTfeUtil_ReadWorkspaceByName_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockTfeUtil_ReadWorkspaceByName_Call) RunAndReturn(run func(string, string, *go_tfe.Client) (*go_tfe.Workspace, error)) *MockTfeUtil_ReadWorkspaceByName_Call {
	_c.Call.Return(run)
	return _c
}
