...
import (
	...
	token_validator "terraform-provider-tfmigrate/internal/util/vcs/git/token_validator"
)

// MockTokenValidatorFactory is an autogenerated mock type for the RemoteVcsSvcProviderFactory type
...
func (_m *MockTokenValidatorFactory) NewRemoteVcsSvcProvider(gitServiceProvider *constants.GitServiceProvider) (token_validator.RemoteVcsSvcProvider, error) {
	...
	var r0 token_validator.RemoteVcsSvcProvider
	var r1 error
	if rf, ok := ret.Get(0).(func(*constants.GitServiceProvider) (token_validator.RemoteVcsSvcProvider, error)); ok {
		return rf(gitServiceProvider)
	}
	if rf, ok := ret.Get(0).(func(*constants.GitServiceProvider) token_validator.RemoteVcsSvcProvider); ok {
		r0 = rf(gitServiceProvider)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(token_validator.RemoteVcsSvcProvider)
		}
	}
...
// MockTokenValidatorFactory_NewTokenValidator_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'NewRemoteVcsSvcProvider'
...
func (_e *MockTokenValidatorFactory_Expecter) NewTokenValidator(gitServiceProvider interface{}) *MockTokenValidatorFactory_NewTokenValidator_Call {
	return &MockTokenValidatorFactory_NewTokenValidator_Call{Call: _e.mock.On("NewRemoteVcsSvcProvider", gitServiceProvider)}
}
...
func (_c *MockTokenValidatorFactory_NewTokenValidator_Call) Return(_a0 token_validator.RemoteVcsSvcProvider, _a1 error) *MockTokenValidatorFactory_NewTokenValidator_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockTokenValidatorFactory_NewTokenValidator_Call) RunAndReturn(run func(*constants.GitServiceProvider) (token_validator.RemoteVcsSvcProvider, error)) *MockTokenValidatorFactory_NewTokenValidator_Call {
	_c.Call.Return(run)
	return _c
}
