...
const (
	...
	PROVIDER_PAT_TOKEN_MISSING_DETAILED = "The provider cannot create the VCS API client as there is a missing or empty value for the VCS API client. Set the password value in the configuration or use the TF_GIT_PAT_TOKEN environment variable. If either is already set, ensure the value is not empty."
