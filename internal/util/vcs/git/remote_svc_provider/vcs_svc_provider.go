...
// RemoteVcsSvcProviderFactory is the factory interface for creating token validators.
...
// NewTokenValidator CreateValidator returns the appropriate RemoteVcsSvcProvider based on the provider.
